...
//                  }
        ...
        //              leaf("Must Yield") {
        //                condition { ctx ->
        //                  exists(ctx.entityIds) { otherVehicleId ->
        ...
        //                    exists(ctx.entityIds) { otherVehicleId ->
        //                      bind(otherVehicleId) { id ->
        //                        hasYielded.holds(ctx, entityId2 = id)
        //                      }
        //                    }
        //                  }
        //                }
        ...
        //            condition { ctx ->
        //              isOnMultiLane.holds(
        //                  ctx, ctx.segment.tickData.first().currentTick,
        ...
        //                monitors { monitor("Right Overtaking") { ctx ->
        // noRightOvertaking.holds(ctx) } }
        //              }
        //              leaf("Pedestrian Crossed") {
        //                projections { projection(LAYER_PEDESTRIAN) }
        //
        ...
        //                monitors { monitor("Crossed red light") { ctx ->
        // !didCrossRedLight.holds(ctx) } }
        //              }
        //            }
        //          }
        //          all("Single-Lane") {
