...
class WeatherWetCloudyTest {

  private val currentWeatherCondition = WeatherType.WetCloudy
  ...
  fun testOtherWeatherConditions() {
    WeatherType.entries.forEach { weatherType ->
      ...
      assertFalse { context.weatherWetCloudy() }
    }
  }
  ...
  fun testWeatherConditions() {
    ...
    assertTrue { context.weatherWetCloudy() }
  }
